...
class IGUserForIGOnlyAPI(
    AbstractCrudObject,
):

    def __init__(self, fbid=None, parent_id=None, api=None):
        self._isIGUserForIGOnlyAPI = True
        super(IGUserForIGOnlyAPI, self).__init__(fbid, parent_id, api)
    ...
    def api_get(self, fields=None, params=None, batch=None, success=None, failure=None, pending=False):
        ...
        request = FacebookRequest(
            ...
            target_class=IGUserForIGOnlyAPI,
            api_type='NODE',
    ...
    def get_business_messaging_feature_status(self, fields=None, params=None, batch=None, success=None, failure=None, pending=False):
        from facebook_business.utils import api_utils
        if batch is None and (success is not None or failure is not None):
          api_utils.warning('`success` and `failure` callback only work for batch call.')
        param_types = {
    ...
    def get_insights(self, fields=None, params=None, is_async=False, batch=None, success=None, failure=None, pending=False):
        ...
        enums = {
            ...
            'metric_type_enum': InsightsResult.MetricType.__dict__.values(),
            'period_enum': InsightsResult.Period.__dict__.values(),
            'timeframe_enum': InsightsResult.Timeframe.__dict__.values(),
        }
        request = FacebookRequest(
            node_id=self['id'],
            method='GET',
